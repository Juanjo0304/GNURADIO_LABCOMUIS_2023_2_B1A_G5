...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._ka_range = Range(-2, 4, 0.5, 1, 200)
        ...
        self._fc_range = Range(50e6, 02.2e9, 1e6, 50e6, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcomu208/Documentos/B1_G5/despecha_rosalia.wav', True)
        self.blocks_null_source_0 = blocks.null_source(gr.sizeof_float*1)
        self.blocks_multiply_const_vxx_2 = blocks.multiply_const_ff(ka)
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.blocks_multiply_const_vxx_2, 0))
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.blocks_multiply_const_vxx_2.set_k(self.ka)

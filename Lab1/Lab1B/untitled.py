...
# Title: Nyquist
# Author: Juan_Morales_Fabian_Moreno_B1A_G5
...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Nyquist", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Nyquist")
        ...
        self._samp_rate_win = RangeWidget(self._samp_rate_range, self.set_samp_rate, "Señal", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._samp_rate_win)
        self._freq_range = Range(1000, 40000, 100, 2000, 200)

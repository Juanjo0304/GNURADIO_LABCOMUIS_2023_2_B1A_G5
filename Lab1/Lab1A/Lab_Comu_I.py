...
# Author: Juan Jose Morales - Fabian Yesid Moreno
...
class Lab_Comu_I(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.frequency = frequency = 1500
        self.amplitud = amplitud = 0

        ##################################################
        # Blocks
        ##################################################

        self._amplitud_range = Range(0, 5, 1, 0, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, frequency, amplitud, 0, 0)

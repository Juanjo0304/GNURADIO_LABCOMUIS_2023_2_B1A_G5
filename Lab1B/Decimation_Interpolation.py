...
class Decimation_Interpolation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Decimation_Interpolation")
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, freq, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, freq, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.rational_resampler_xxx_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.qtgui_freq_sink_x_0, 2))
        self.connect((self.rational_resampler_xxx_1, 0), (self.qtgui_time_sink_x_0, 2))
    ...
    def set_freq(self, freq):
        ...
        self.analog_sig_source_x_2.set_frequency(self.freq)




def main(top_block_cls=Decimation_Interpolation, options=None):

...
class Lab_punto5b(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab_comu", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab_comu")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_punto5b")
...
def main(top_block_cls=Lab_punto5b, options=None):

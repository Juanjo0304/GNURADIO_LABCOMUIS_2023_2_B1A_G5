...
class QAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Fm2_range = Range(0, 1e6, 100, 1e3, 200)
        ...
        self._Fm1_range = Range(0, 1e6, 100, 1e3, 200)
        ...
        self._Fc_range = Range(50e6, 2.2e9, 1e6, 500e6, 200)
        ...
        self._Am_range = Range(0, 1, 10e-3, 250e-3, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, Fm2, Am, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, Fm1, Am, 0, 0)
        self._Ac_range = Range(0, 500e-3, 10e-3, 250e-3, 200)

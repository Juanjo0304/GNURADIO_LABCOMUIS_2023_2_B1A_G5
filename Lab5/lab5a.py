...
class lab5a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab5a")
        ...
        self._Am_range = Range(0, 1, 0.1, 1, 200)
...
def main(top_block_cls=lab5a, options=None):

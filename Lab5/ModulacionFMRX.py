...
# Title: Demodulador de emisoras
# Author: Fabian_JuanJose
# Copyright: UIS
...
class ModulacionFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Demodulador de emisoras ", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demodulador de emisoras ")

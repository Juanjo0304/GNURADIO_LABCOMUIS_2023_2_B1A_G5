...
# Title: MultiplexaPAM
# Author: Juan Fabian Morales Moreno
...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._D4_win = RangeWidget(self._D4_range, self.set_D4, "Selección señal RX", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._Am_win = RangeWidget(self._Am_range, self.set_Am, "Amplitud de Mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_delay_0_2 = blocks.delay(gr.sizeof_float*1, 50-D)
        self.blocks_delay_0_1_0 = blocks.delay(gr.sizeof_float*1, 50-D)
        self.blocks_delay_0_1 = blocks.delay(gr.sizeof_float*1, 50-D)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_float*1, 50-D)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 50-D)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0_3 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fs, 1, 0, 0)
        self.analog_sig_source_x_0_2_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 1000, 1, 0, 0)
        self.analog_sig_source_x_0_2 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fm, Am, 0, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, fm, Am, 0, 0)
        self.analog_sig_source_x_0_0_1_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fs, 1, 0, 0)
        self.analog_sig_source_x_0_0_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fs, 1, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fs, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fs, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.blocks_multiply_xx_0_1, 0))
        self.connect((self.analog_sig_source_x_0_0_1, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.analog_sig_source_x_0_0_1, 0), (self.blocks_multiply_xx_0_2, 0))
        self.connect((self.analog_sig_source_x_0_0_1_0, 0), (self.blocks_delay_0_1_0, 0))
        self.connect((self.analog_sig_source_x_0_0_1_0, 0), (self.blocks_multiply_xx_0_2_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_throttle_0_0, 0))
        self.connect((self.analog_sig_source_x_0_2, 0), (self.blocks_throttle_0_1, 0))
        self.connect((self.analog_sig_source_x_0_2_0, 0), (self.blocks_throttle_0_1_0, 0))
        self.connect((self.analog_sig_source_x_0_3, 0), (self.blocks_delay_0_2, 0))
        self.connect((self.analog_sig_source_x_0_3, 0), (self.blocks_multiply_xx_0_3, 0))
        ...
        self.connect((self.blocks_delay_0_0, 0), (self.blocks_multiply_xx_0_1, 1))
        self.connect((self.blocks_delay_0_1, 0), (self.blocks_multiply_xx_0_2, 1))
        self.connect((self.blocks_delay_0_1_0, 0), (self.blocks_multiply_xx_0_2_0, 1))
        self.connect((self.blocks_delay_0_2, 0), (self.blocks_multiply_xx_0_3, 1))
        ...
        self.connect((self.blocks_delay_2_0, 0), (self.blocks_add_xx_0, 3))
        self.connect((self.blocks_delay_2_0, 0), (self.qtgui_time_sink_x_0, 3))
        self.connect((self.blocks_delay_3, 0), (self.blocks_throttle_0_2, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0_0, 0), (self.blocks_delay_1, 0))
        self.connect((self.blocks_multiply_xx_0_0_1, 0), (self.blocks_delay_2, 0))
        self.connect((self.blocks_multiply_xx_0_0_1_0, 0), (self.blocks_delay_2_0, 0))
        self.connect((self.blocks_multiply_xx_0_0_2, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_multiply_xx_0_0_2, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.blocks_multiply_xx_0_0_0, 1))
        self.connect((self.blocks_multiply_xx_0_2, 0), (self.blocks_multiply_xx_0_0_1, 1))
        self.connect((self.blocks_multiply_xx_0_2_0, 0), (self.blocks_multiply_xx_0_0_1_0, 1))
        self.connect((self.blocks_multiply_xx_0_3, 0), (self.blocks_multiply_xx_0_0_2, 1))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.blocks_multiply_xx_0_0_0, 0))
        self.connect((self.blocks_throttle_0_1, 0), (self.blocks_multiply_xx_0_0_1, 0))
        self.connect((self.blocks_throttle_0_1_0, 0), (self.blocks_multiply_xx_0_0_1_0, 0))
        self.connect((self.blocks_throttle_0_2, 0), (self.blocks_multiply_xx_0_0_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_sig_source_x_0_0_1_0.set_sampling_freq(self.samp_rate)
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, 100, 1000, window.WIN_HAMMING, 6.76))
    ...
    def set_fs(self, fs):
        ...
        self.analog_sig_source_x_0_0_0.set_frequency(self.fs)
        self.analog_sig_source_x_0_0_1.set_frequency(self.fs)
        self.analog_sig_source_x_0_0_1_0.set_frequency(self.fs)
        self.analog_sig_source_x_0_3.set_frequency(self.fs)
    ...
    def set_D3(self, D3):
        self.D3 = D3
        self.blocks_delay_2_0.set_dly(self.D3)
    ...
    def set_D(self, D):
        ...
        self.blocks_delay_0_0.set_dly(50-self.D)
        self.blocks_delay_0_1.set_dly(50-self.D)
        self.blocks_delay_0_1_0.set_dly(50-self.D)
        self.blocks_delay_0_2.set_dly(50-self.D)
